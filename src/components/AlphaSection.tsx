const PERKS = [
  ...
  },
  {
    ...
    text: "Chaque quantité que vous rectifiez me dit où l'IA se trompe et sur quel poste concentrer le travail. Vos dossiers façonnent le produit.",
  },
  {
    tag: "Contact",
    title: "Ligne directe, pas de support ticket",
    text: "Un builder, pas une équipe. Vous répondez à mon email, je réponds au vôtre. Un point de 20 minutes par visio si vous le souhaitez.",
  },
];
